...
let sdk = new UiPath({
  ...
  scope: 'OR.Administration.Read OR.Jobs.Read OR.Users OR.Folders.Read DataFabric.Data.Read DataFabric.Schema.Read offline_access',
...
export default { sdk, codedActionAppsService, entityService, attachmentService };